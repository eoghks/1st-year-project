...
<head>
	...
	<link href="/board_JPA/static/css/manageCloud.css" rel="stylesheet">
	<meta charset="UTF-8">
...
<body>
	...
	<div class="container">
		...
		<div>
			...
			<input type="number" id="name3" class="i1 hidden" min="0" max="3"></input>
	...
	<script>
		...
		$('#lang').change(function(){
			var url =$(location).attr("origin")+"/board_JPA"+"?lang="+$(this).val();
		...
		$('#delete').click(function(){
			...
			var url =$(location).attr("origin")+"/board_JPA/delete";
			$.ajax({
				url: url,
				type:"POST",
				async:false,
		...
		$("#search").click(function(){
			...
			var url =$(location).attr("origin")+"/board_JPA/search";
			$.ajax({
				url: url,
				type:"POST",
				async:false,
		...
		function click(option) {
			...
			var url ='/board_JPA/property?host_name='+encodeURIComponent(host_name)
			if(option==="new"){
